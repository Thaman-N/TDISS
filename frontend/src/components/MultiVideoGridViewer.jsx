...
const MultiVideoGridViewer = () => {
  ...
  const [mutedVideos, setMutedVideos] = useState(new Set(jobIds)); // Start all muted for autoplay
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className={`grid ${getGridClass(jobIds.length)} gap-6`}>
        {jobIds.map((jobId) => {
          ...
          const isViolent = video.status === 'completed' && video.has_violence;
          const isSafe = video.status === 'completed' && !video.has_violence;
